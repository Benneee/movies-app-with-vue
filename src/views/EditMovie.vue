<template>
    <div class="container">
        <Header />
        <h3 class="welcome">Update the movie details</h3>
        ...
        <form class="form" @submit.prevent="handleSubmit">
            ...
            <button class="submit-button" type="submit">Update movie</button>
        </form>
    </div>
</template>
<script setup>
...
const handleSubmit = async () => {
    ...
    await axios
        .put(`http://localhost:8000/movies/${data.id}`, {
            title: data.title,
            isbn: data.isbn,
            director: {
                ...data.director,
